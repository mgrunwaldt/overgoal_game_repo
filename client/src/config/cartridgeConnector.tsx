  ...
  contracts: {
    [CONTRACT_ADDRESS_GAME]: {
      methods: [
        ...
        { name: "improve_team_relationship", entrypoint: "improve_team_relationship" },
        ...
        { name: "update_team_points", entrypoint: "update_team_points" },
                ...
                { name: "add_opponent_team_goal", entrypoint: "add_opponent_team_goal" },
                // Non-Match Event permissions
                { name: "seed_non_match_events", entrypoint: "seed_non_match_events" },
                { name: "trigger_non_match_event", entrypoint: "trigger_non_match_event" },
                { name: "look_for_sponsor_deals", entrypoint: "look_for_sponsor_deals" },
        ...
        { name: "execute_non_match_event", entrypoint: "execute_non_match_event" },
            ],
    },
  },
}
