...
export default function NonMatchEventSelector() {
  ...
  useEffect(() => {
    if (nonMatchEvents.length > 0) {
      const items = gsap.utils.toArray(".non-match-item");
      const npcImage = gsap.utils.toArray(".npc-image");
  ...
  return (
    <div
      style={{
        backgroundImage: "url('/Screens/login/BackGround.png')",
        mixBlendMode: "normal",
        backgroundPosition: "center",
        backgroundSize: "cover",
      }}
    >
      <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-cover bg-center relative overflow-hidden bg-black/50 mix-blend-normal backdrop-blur-[2px]">
        ...
        {/* Header */}
        <div className="flex items-center justify-center mb-6 w-full max-w-6xl text-center">
        ...
        <div className="flex flex-row space-x-4  mb-10 items-center justify-center">
          <img
            src="/nonMatchEvent/Npc.png"
            alt="Npc"
            className="w-1/3 h-1/3 npc-image opacity-0"
          />
          <img
            src="/nonMatchEvent/text-buble.png "
            alt="Text Buble"
            className="w-1/2 h-1/2 npc-image opacity-0"
          />
        </div>
