...
pub impl ZeroableNonMatchEventTrait of Zero<NonMatchEvent> {
    #[inline(always)]
    fn zero() -> NonMatchEvent {
        NonMatchEvent {
            event_id: 0,
            name: 0,
            description: 0,
    ...
    #[inline(always)]
    fn is_zero(self: @NonMatchEvent) -> bool {
        *self.event_id == 0
    }

    #[inline(always)]
    fn is_non_zero(self: @NonMatchEvent) -> bool {
        !self.is_zero()
    }
}

pub impl ZeroableNonMatchEventOutcomeTrait of Zero<NonMatchEventOutcome> {
    #[inline(always)]
    fn zero() -> NonMatchEventOutcome {
        NonMatchEventOutcome {
            event_id: 0,
            outcome_id: 0,
            outcome_type: 0,
    ...
    #[inline(always)]
    fn is_zero(self: @NonMatchEventOutcome) -> bool {
        *self.event_id == 0 && *self.outcome_id == 0
    }

    #[inline(always)]
    fn is_non_zero(self: @NonMatchEventOutcome) -> bool {
        !self.is_zero()
    }
}

pub impl ZeroablePlayerEventHistoryTrait of Zero<PlayerEventHistory> {
    #[inline(always)]
    ...
    #[inline(always)]
    fn is_zero(self: @PlayerEventHistory) -> bool {
        *self.player == constants::ZERO_ADDRESS() && *self.event_id == 0
    }

    #[inline(always)]
    fn is_non_zero(self: @PlayerEventHistory) -> bool {
        !self.is_zero()
    }
} 